...
describe("Safe", function () {
  ...
  it("initialize space", async function () {
    ...
    const tokenbob = fhevmInstance.bob.getTokenSignature(addressEncryptedERC20) || {
      signature: "",
      publicKey: "",
    };
    const tokencarol = fhevmInstance.carol.getTokenSignature(addressEncryptedERC20) || {
      signature: "",
      publicKey: "",
    };
    const tokendave = fhevmInstance.dave.getTokenSignature(addressEncryptedERC20) || {
      signature: "",
      publicKey: "",
    };
    ...
    // console.log(await contractEncryptedERC20.decr(this.signers.bob.getAddress()));
    // console.log(await contractEncryptedERC20.decr(this.signers.carol.getAddress()));
    // console.log(await contractEncryptedERC20.decr(this.signers.dave.getAddress()));
    ...
    console.log(await contractEncryptedERC20._bal(this.signers.bob.getAddress()));
    console.log(await contractEncryptedERC20._bal(this.signers.carol.getAddress()));
    console.log(await contractEncryptedERC20._bal(this.signers.dave.getAddress()));

    // let a = await contractEncryptedERC20.connect(this.signers.bob).balanceOf(tokenbob.publicKey, tokenbob.signature);
    // let b = await contractEncryptedERC20.connect(this.signers.carol).balanceOf(tokencarol.publicKey, tokencarol.signature);
    // let c = await contractEncryptedERC20.connect(this.signers.dave).balanceOf(tokendave.publicKey, tokendave.signature);

    // console.log("Bob Safe balance: " + fhevmInstance.bob.decrypt(addressEncryptedERC20, a).toString());
    // console.log("Carol Safe balance: " + fhevmInstance.carol.decrypt(addressEncryptedERC20, b).toString());
    // console.log("Dave Safe balance: " + fhevmInstance.dave.decrypt(addressEncryptedERC20, c).toString());


    // console.log(await contractEncryptedERC20.connect(this.signers.bob).decr());
    // console.log(await contractEncryptedERC20.connect(this.signers.carol).decr());
    // console.log(await contractEncryptedERC20.connect(this.signers.alice).decr());


    // console.log(encBalanceBob);
    // console.log(encBalanceCarol);
    // console.log(encBalanceDave);

    // console.log("balance of" + fhevmInstance.bob.decrypt(addressEncryptedERC20, encBalanceBob).toString());
    // console.log("balance of" + fhevmInstance.carol.decrypt(addressEncryptedERC20, encBalanceCarol).toString());
    // console.log("balance of" + fhevmInstance.dave.decrypt(addressEncryptedERC20, encBalanceDave).toString());
